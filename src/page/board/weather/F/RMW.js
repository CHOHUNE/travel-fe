...
export function RMW() {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?q=roma&appid=985c5eb268728c7749b67d03c99b6c37`;
  ...
  return (
    <Card maxW="sm" textAlign={"center"}>
      <CardBody>
        <Image
          src="
        https://study1993garbi.s3.ap-northeast-2.amazonaws.com/travel/board/48/%EB%A1%9C%EB%A7%88.jpg"
