...
export function Seoul() {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?q=Seoul&appid=985c5eb268728c7749b67d03c99b6c37`;
  ...
  return (
    <Card maxW="sm" textAlign={"center"}>
      <CardBody>
        <Image
          src="
         https://study1993garbi.s3.ap-northeast-2.amazonaws.com/travel/board/51/%EC%84%9C%EC%9A%B8.jpg"
          alt="Green double couch with wooden legs"
          borderRadius="lg"
        />

        <Stack mt="6" spacing="3">
          <Heading size="md"> 서울 날씨</Heading>
