...
export function DUW() {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?q=Dubai&appid=985c5eb268728c7749b67d03c99b6c37`;
  ...
  return (
    <Card maxW="sm" textAlign={"center"}>
      <CardBody>
        <Image
          src="
         https://study1993garbi.s3.ap-northeast-2.amazonaws.com/travel/board/48/%EB%91%90%EB%B0%94%EC%9D%B4.jpg "
