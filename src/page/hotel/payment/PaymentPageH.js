  ...
  useEffect(() => {
    ...
    tossPayments
      .requestPayment("카드", {
        ...
        successUrl: "http://localhost:3000/successpageHotel?id=" + id, // 결제 성공 시 이동할 페이지(이 주소는 예시입니다. 상점에서 직접 만들어주세요.)
        failUrl: "http://localhost:3000/failHotle", // 결제 실패 시 이동할 페이지(이 주소는 예시입니다. 상점에서 직접 만들어주세요.)
      })
      // ------결제창을 띄울 수 없는 에러 처리 ------
